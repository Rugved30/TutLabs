        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-white-500 focus:border-transparent"
            />
          </div>

          {/* Popular Subjects */}
          <div className="mt-4">
            <p className="text-sm text-white-600 mb-2">Popular Subjects:</p>
